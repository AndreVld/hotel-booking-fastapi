...
async def test_get_hotels_by_location_and_date(
...
@pytest.mark.parametrize(
    ...
    [
        (4, "2030-05-01", "2030-05-15", booked_rooms, 200)
        for booked_rooms in range(3, 11)
    ]
...
async def test_add_and_get_booking(
    ...
    responce: Response = await authenticated_ac.post(
        "/bookings",
        params={
            "room_id": room_id,
            "date_from": date_from,
