...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            2,
            7,
            dt.strptime("2026-05-10", "%Y-%m-%d"),
            dt.strptime("2026-05-24", "%Y-%m-%d"),
        ),
        (
            1,
            5,
            dt.strptime("2026-06-10", "%Y-%m-%d"),
            dt.strptime("2026-06-24", "%Y-%m-%d"),
        ),
        (
            2,
            1,
...
async def test_create_read_delete_booking(user_id, room_id, date_from, date_to):
